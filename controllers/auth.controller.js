...
export const signUp = async(req,res,next)=>{
    ...
    session.startTransaction(); //we do this to perform atomic operations
    try {
        // logic to insert a new user/create a new user
        ...
        // this session enduk ante emmana avte apeyaniki lekapithe committransactions
...
export const signIn = async(req,res,next)=>{
    ...
    try {
        ...
        if(!user){
            const error = new Error("User not founf")
